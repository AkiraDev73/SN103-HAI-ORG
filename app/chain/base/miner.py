...
class BaseMinerNeuron(BaseNeuron):
    ...
    def __init__(self):
        ...
        self.axon.attach(
            forward_fn=self.forward_completion,
            blacklist_fn=self.blacklist_completion,
            priority_fn=self.priority_completion,
        )
    ...
    async def forward_completion(self, query: CompletionSynapse) -> CompletionSynapse:
        bt.logging.warning("unimplemented: forward_completion()")
    ...
    async def blacklist_completion(
        self, synapse: CompletionSynapse
    ) -> typing.Tuple[bool, str]:
        return await self.blacklist(synapse)

    async def priority_completion(self, synapse: CompletionSynapse) -> float:
